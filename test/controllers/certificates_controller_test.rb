...
class CertificatesControllerTest < ActionController::TestCase
  ...
  test "should create certificate" do
    assert_difference('Certificate.count') do
      post :create, certificate: { brainsize: @certificate.brainsize, hunger: @certificate.hunger, iq: @certificate.iq }
    end
  ...
  test "should update certificate" do
    patch :update, id: @certificate, certificate: { brainsize: @certificate.brainsize, hunger: @certificate.hunger, iq: @certificate.iq }
    assert_redirected_to certificate_path(assigns(:certificate))
  end
